...
OUTPUT_FILE_NAME=test_results/debian/test_output_$FILE_EXTENSION.txt
TIME_FILE_NAME=test_results/debian/test_duration_$FILE_EXTENSION.txt
RESOURCES_FILE_NAME=test_results/debian/test_internal_resources$FILE_EXTENSION.csv
